...
<table><tr>
<td>
<font color="black" face="arial" size="4"><b> | Resultados Locales Encontrados | </b></font>
</td>
</tr></table>
<hr />
...
<td>
		...
		<div style="width:190px;">
			<center><a id="<?php echo $frase; ?>" href="<?php echo $html->url('/',true)?>pages/detallelocales/<?php echo $locales[$i]['Locale']['rif']; ?>/<?php echo $frase; ?>" ><img src="<?php echo $html->url('/')?>files/locales/thumbnails/<?php echo $locales[$i]['Locale']['nombre_file'];?>" style="margin-bottom:5px;height:80px;width:100px;" ></a></center>
			<br /><center>
			<font color="black"><b>
...
<td>
		...
		<div style="width:190px;">
			<center><a href="<?php $i++; echo $html->url('/',true)?>pages/detallelocales/<?php echo $locales[$i]['Locale']['rif']; ?>/<?php echo $frase; ?>" ><img src="<?php echo $html->url('/')?>files/locales/thumbnails/<?php echo $locales[$i]['Locale']['nombre_file'];?>" style="margin-bottom:5px;height:80px;width:100px;" ></a><center>
			<br /><center>
			<font color="black"><b>
			<?php echo $locales[$i]['Locale']['nombre_empresa'];?><br/>
			<?php echo $locales[$i]['Locale']['telefono_cel'];?><br/>
