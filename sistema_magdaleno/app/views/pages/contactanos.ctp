				...
				<fieldset class="contactos">
						...
						<table border="0"  >
			        		<tr>
		                		...
		                		<td>
		                			<font color="red"><?php echo $this->Form->input('correo', array("label" => false, "class" => "","required" => "email")); ?></font><b><br>
		                		</td>
		            		</tr>         
		            		<tr>
		                		<td class="" style=""><b>Nombre Completo:</b></td>
		            	    	<td><font color="red"><?php echo $this->Form->input('nombre', array("label" => false, "class" => "",'maxlength'=>'50',"required" => "required")); ?></font><br>
		                		</td>
		                    <tr>
		                		<td class="" ><b>Tel&eacute;fono:</b></td>
		                		<td><font color="red"><?php echo $this->Form->input('codi',array("class"=>"","label"=>false,"div"=>false,"options" => array($cod),"empty"=>"----"));?><?php echo $this->Form->input('telefono', array("label" => false, "class" => "telefono","div"=>false,"error" => true,"maxlength"=>7,"required" => "required")); ?></font><br>
		                		</td>
		            		</tr>
		                    <tr>
		            		...
		            		<tr id="stado">
								...
								?>
		            		<tr>
		                		<td colspan="2" style="text-align: center;"><?php echo $this->Form->submit('Aceptar',array('class' => '	', 'title' => 'Custom Title')); ?><br>
		                		</td>
		            		</tr>
			            </table>
				</fieldset>
