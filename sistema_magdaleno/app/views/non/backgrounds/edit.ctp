...
<?php echo $this->Form->create('Background');?>
	...
	<?php
		echo $this->Form->input('id_background');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Background.id_background')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Background.id_background'))); ?></li>
