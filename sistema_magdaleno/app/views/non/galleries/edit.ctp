...
<?php echo $this->Form->create('Gallery');?>
	...
	<?php
		echo $this->Form->input('id_galeria');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Gallery.id_galeria')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Gallery.id_galeria'))); ?></li>
