...
<div class="capa">
<?php
  echo "<div class='titulo_barra'><h2>Registrar Galeria</h2></div>";
   ...
   echo $form->input('garantia',array('id'=>'codigo','label'=>'Garantia:','id'=>'buscar_seleccion','options'=>array(
      'Si'=>'Si',
	  'No'=>'No'
	   ),'empty'=>'Seleccione'
       ))."";
   ...
   echo "<p>".$form->input('publicar',array('type'=>'checkbox','label'=>'<span>Publicar</span>'))."</p>";
   ...
   echo $form->input('usuario_id_usuario', array('type'=>'hidden','value'=>$session->read('Auth.User.id_usuario')));
    echo "<br/>".$form->end('Crear Galeria')."<br/>";
?>
</div>