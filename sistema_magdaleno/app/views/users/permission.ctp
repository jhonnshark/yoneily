...
<h1>Asignar Permisos de usuario</h1>
<div>
                ...
                <p id="enviar">
                    ...
                    foreach($hijo[$cod] as $idhijo => $hijoalias){
                        ...
                        if(!$permiso[$idhijo])
                        {
                           ...
                           echo "<td class ='texto'>Este usuario no tiene permisos</td>";
                            //echo "<td>".$this->Html->link(array('action' => '/'),$this->Html->image('Cross.png'))."</td>";
                            echo "<td id='enviar'>".
                                    $this->Html->image("Cross.png", array("alt" => 'key='.$iduser.'&key2='.$hijoalias.'&key3='.$permisosflag ,"style" =>"display:inline;","class"=>"tilde")).
                                    $this->Html->image("ajax-loader.gif", array("style" =>"display:none;","class"=>"cargador")).
                                    "</td>";
                           }else{
                            $permisosflag = 1;
                           
                             echo "<td class ='texto'>Este Usuario tiene permisos</td>";
                             echo "<td id='enviar'>".
                                    $this->Html->image("Green_tick.png", array("alt" => 'key='.$iduser.'&key2='.$hijoalias.'&key3='.$permisosflag ,"style" =>"display:inline;","class"=>"tilde")).
