<?php
   ...
   // Add scaffold defaults if scaffolds are being used
            ...
            if (array_key_exists('scaffold',$properties)) {
                if($properties['scaffold'] == 'bckequilibrio') {
                     $methods = array_merge($methods, array('bckequilibrio_add', 'bckequilibrio_edit', 'bckequilibrio_index', 'bckequilibrio_view', 'bckequilibrio_delete'));
                } else {
