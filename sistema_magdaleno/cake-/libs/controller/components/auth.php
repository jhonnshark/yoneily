 ...
 */
	function __setDefaults() {
		...
		$defaults = array(
			...
			'loginError' => __('Fallo Inicio de Sesion. Usuario Invalido o Password Para acceder a Muebleria Magdaleno.', true),
			'authError' => __('Usted no est&aacute; autorizado para acceder a Muebleria Magdaleno.', true)
